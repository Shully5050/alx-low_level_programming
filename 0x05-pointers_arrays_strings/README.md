...
File: 4-print8-rev.c is a function that prints a string, in reverse, followed by a new line.

File: 5-rev-string.c is a function that reverses a string.

File: 6-puts2.c is a function that prints one char out of 2 of a string, followed by a new line.

File: 7-puts-half.c is a function that prints half of a string, followed by a new line.

File: 8-print-array.c is a function that prints n elements of an array of integers, followed by a new line.
